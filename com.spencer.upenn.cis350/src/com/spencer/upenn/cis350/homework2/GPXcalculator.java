...
public class GPXcalculator {
     ...
     * @return the total distance in meters; return -1 if trk is null, the input
     *         is not valid, or if an error occurs
     */
    public static double calculateDistanceTraveled(GPXtrk trk) {
    	/*
    	 * DO NOT IMPLEMENT THIS METHOD!!
    	 * 
    	 * It is only provided to you so that you can compile your test cases!!
    	 */
    	return -5.0;
    }
